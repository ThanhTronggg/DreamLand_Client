...
import iuh.fit.gui.other.CtrlLoginForm;
...
//		setImage(imageIcon.getImage());
	...
	public void showSplashScreen(Runnable onSplashFinished) {
        ...
        SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
            ...
            protected Void doInBackground() throws Exception {
                Thread.sleep(2500);  // Thời gian hiển thị splash screen
                return null;
            }
    ...
    public void createSplashScreen() {
        ...
        JLabel imageLabel = new JLabel(new ImageIcon("images/logo_by_cahn (1).jpeg"), SwingConstants.CENTER);
