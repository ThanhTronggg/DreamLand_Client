...
public class DoiMatKhau extends JPanel {
	...
	private void initComponents(NhanVien nhanVien) {
		...
		informationLabel = new JLabel(nhanVien.getHoTen() + " - " + nhanVien.getVaiTro());
	...
	private void handleChangePassword() throws RemoteException {
		...
		boolean success = taiKhoanDAO.doiMatKhau(nhanVien.getTaiKhoan().getTaiKhoan(), currentPassword, newPassword);
		if (success) {
